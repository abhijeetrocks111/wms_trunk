...
public class TestSiteSection extends TestNGBaseTest {
	...
	public void testLockUnlockArchieveSite() throws Exception {
		...
		String successMessage = "Site Locked successfully";
		
		logStep("Perform Lock Action from Manage");
		manageSiteSectionPage.clickLockUnlockButton();
		assertTrue(manageSiteSectionPage.getMessages(successMessage), successMessage+" - Message is Displayed");
		
		successMessage = "Site Unlocked successfully";
		
		logStep("Perform Unlock Action from Manage");
		manageSiteSectionPage.clickLockUnlockButton();
		assertTrue(manageSiteSectionPage.getMessages(successMessage), successMessage+" - Message is Displayed");
		
		logStep("Archieve Site");
		manageSiteSectionPage.clickArchieve();
		
		successMessage = "Site Archive successfully";
		assertTrue(manageSiteSectionPage.getMessages(successMessage), successMessage+" - Message is Displayed");
		
		logStep("Navigate to Archived Site List Page");
		manageSiteSectionPage = manageSiteSectionPage.clickArchieveSitesButton();
		assertTrue(manageSiteSectionPage.isSectionPageTitleDisplayed("Archived Site List"),"Archived Site List Page is Displayed");
		...
		logStep("Delete Site");
		manageSiteSectionPage.clickDeleteSite();
		assertTrue(manageSiteSectionPage.getMessages(successMessage), successMessage+ " is Displayed");
